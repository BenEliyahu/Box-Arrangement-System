...
namespace Boxes
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int checkNum;
            int.TryParse(invoke, out checkNum);
            ...
            int numOFStockMin;
            int.TryParse(invoke, out numOFStockMin);
            ...
            while (main)
            {
                ...
                switch (messageBoxResult)
                {
                    ...
                    case MessageBoxResult.No:
                        ...
                        bool collection = n.ShowCollection(out shop);
                        if (collection)
                        {
                            Console.WriteLine("Welcome to the family warehouse! Below is our warehouse:\n");
